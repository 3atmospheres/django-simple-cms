...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Navigation.dropdown'
        db.add_column(u'simple_cms_navigation', 'dropdown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Navigation.dropdown'
        db.delete_column(u'simple_cms_navigation', 'dropdown')
